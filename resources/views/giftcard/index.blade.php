            ...
            <div class="card card-custom bg-white gutter-b">
                ...
                <div class="card-header border-0 pt-5">
                    <h3 class="card-title align-items-baseline flex">
                        ...
                        <span class="card-label font-weight-bold font-size-h2 text-dark-75">Buy Gift Card</span>
                    </h3>
                </div>
                <!--end::Header-->
                <!--begin::Body-->
                <div class="card-body pt-1">
                    <div class="tab-content mt-5" id="myTabContent">
                        ...
                        <div class="tab-pane fade show active">
                            <!--begin::Form-->
                            <form class="form align-items-center" enctype="multipart/form-data" method="post" action="{{route('giftcard.store')}}">
                                @csrf
                                ...
                                <div class="row">
                                    <label class="col-md-3 col-form-label">Select Your Giftcard</label>
                                    <div class="col-md-9">
                                        <select id="cardSelection" class="selectpicker btn btn-secondary" name="giftcard_id" data-live-search="true" data-style="select-with-transition" title="Choose Gift Card" data-size="7" required="true">
                                            <option selected> Select Gift Card</option>

                                            @foreach($giftcards as $operator)
                                ...
                                <div class="row mt-5">
                                    <label class="col-md-3 col-form-label">Email <small>(Gift card will send to this email)</small></label>
                                    <div class="col-md-9">
                                        <div class="form-group">
                                            <input id="email" value="{{old('email') ?? ''}}" type="email" name="email" class="form-control" required="true">
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <div class="form-group">
                                            <input id="usd_amount" value="{{old('amount_usd')?? '0.00'}}" type="text" name="amount_usd" class="form-control" required="true" readonly>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row" style="margin-top: 10px;">
                                    <label class="col-md-3 col-form-label">Amount in Naira</label>
                                    <div class="col-md-9">
                                        <div class="form-group">
                                            <input id="base_amount" value="{{old('amount_base') ?? '0.00'}}" type="text" name="amount_base" class="form-control"  readonly>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <div class="form-group">
                                            <input id="btc_amount" value="{{old('amount_btc')?? '0.00'}}" type="text" name="amount_btc" class="form-control" readonly>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mt-4">
                                    <button type="submit" class="btn btn-primary font-weight-bold">Buy Now</button>
                                </div>
                            </form>
                            <!--end::Form-->
                        </div>
        ...
        <div class="col-12">
            ...
            <div class="card card-custom gutter-b">
                    ...
                    <div class="table-responsive">
                        <table class="table table-head-custom table-vertical-center" id="kt_advance_table_widget_2">
                            ...
                            <tr class="text-uppercase">
                                ...
                                <th style="min-width: 120px">Card Name</th>
                            ...
                            @foreach($cardorders as $recharge)
                                <tr>
                                    ...
                                    <td>
                                        <span class="text-dark-75 font-weight-bolder d-block font-size-lg">{{$recharge->giftcard->name}}</span>

                                    </td>
                                    <td>
																	<span
                                                                        class="text-dark-75 font-weight-bolder d-block font-size-lg">{{$recharge->email}}</span>
                                    </td>
                                    <td>
																	<span
                                                                        class="text-dark-75 font-weight-bolder d-block font-size-lg">{{$recharge->amount_base}}</span>
                                    ...
                                    <td class="pr-0 text-right">
                                        <a href="{{route('giftcard.show',$recharge->id)}}" class="btn btn-icon btn-light btn-hover-primary btn-sm">
                ...
                <div class="card-footer">
                    <div class="d-flex justify-content-center">{{$cardorders->links()}}</div>
                </div>
            </div>
...
<script>
    ...
    selection.onchange = function(event){
        ...
        const naira_amount = document.getElementById("base_amount");
