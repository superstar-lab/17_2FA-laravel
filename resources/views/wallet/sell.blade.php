            ...
            <div class="card card-custom bg-white gutter-b">
                ...
                <div class="card-header border-0 pt-5">
                    <h3 class="card-title align-items-baseline">
                        ...
                        <span class="card-label font-weight-bold font-size-h2 text-dark-75">Sell Bitcoin From GCBUYING wallet</span>
                    </h3>
                </div>
...
{{--                        </div>--}}
                                        ...
                                        <input id="address" name="address" type="text" class="form-control" value="{{$bitcoin->address}}" hidden/>
                            ...
                            <div class="col-md-9">
                                <div class="form-group">
                                    <input id="get_amount" value="0.00" type="text" name="get_amount" class="form-control" readonly>
                                </div>
                            </div>
                            </div>


                            <input type="text"  id="sell_rate" value="{{$bitcoin->rate}}" hidden>

                            <div class="row mt-4">
                                <input type="text"  id="sell_rate" value="0" hidden>
                                <button id="submit" style="display: none" type="submit" class="btn btn-primary font-weight-bold">Sell Bitcoin</button>
                            </div>
            ...
            <div class="card card-custom gutter-b">
                ...
                <div class="card-header border-0 py-5">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label font-weight-bolder text-dark">Sell History</span>
                        <span class="text-muted mt-3 font-weight-bold font-size-sm">Showing Latest Sell History</span>
                    </h3>
                        ...
                        <table class="table table-head-custom table-vertical-center" id="kt_advance_table_widget_2">
                            ...
                            @foreach($sells as $sell)
                                <tr>
                                    ...
                                    <td class="pl-0">
                                        <a href="#"
                                           class="text-dark-75 font-weight-bolder text-hover-primary font-size-lg">{{$sell->txid}}</a>
                                    </td>
                                    <td>
                                        <span class="text-dark-75 font-weight-bolder d-block font-size-lg">{{$sell->amount_btc}}</span>

                                    </td>
                                    <td>
																	<span
                                                                        class="text-dark-75 font-weight-bolder d-block font-size-lg">{{$sell->amount_naira}}</span>
                                    </td>
                                    <td>
																	<span
                                                                        class="text-dark-75 font-weight-bolder d-block font-size-lg">{{$sell->status}}</span>

                                    </td>
                                    <td>
																	<span
                                                                        class="text-dark-75 font-weight-bolder d-block font-size-lg">{{$sell->created_at}}</span>
...
<script>
    ...
    const sell_rate = document.getElementById("sell_rate");
    let fee = 0;
        ...
        function updateValue(e) {
            ...
            fetch('/api/get_network_fee', {
                ...
                .then(data => {
                    ...
                    rate = sell_rate.value;
                    get_amount.value = parseFloat(btc_amount.value) * rate * btc_rate;
                    if(data.status === 'fail'){
