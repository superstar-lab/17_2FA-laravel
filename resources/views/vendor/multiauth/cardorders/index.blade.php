        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header card-header-primary card-header-icon">
                    ...
                    <h4 class="card-title">Gift Card Orders</h4>
                </div>
                <div class="card-body">
                    <div class="toolbar">
                    ...
                    <div class="material-datatables">
                        <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                            ...
                            @foreach($orders as $recharge)
                                <tr>
                                    <td>{{$recharge->txid}}</td>
                                    <td>{{$recharge->giftcard->name ?? ''}}</td>
                                    <td>{{$recharge->email}}</td>
                                    <td>{{$recharge->amount_base}}</td>
                                    ...
                                    <td class="text-right">
                                        <a href="{{route('admin.cardorder.show',['id' => $recharge->id])}}" class="btn btn-link btn-warning btn-just-icon edit"><i class="material-icons">dvr</i></a>
                                    </td>
                                </tr>
                            @endforeach
