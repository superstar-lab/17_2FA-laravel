        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header card-header-icon card-header-rose">
                    <div class="card-icon">
                        <i class="material-icons">USDT</i>
                    </div>
                </div>
                <div class="card-body">
                    <h3 class="card-title text-center"><strong>USDT</strong></h3>
                ...
                <div class="card card-signup card-plain">
                    <div class="modal-header">
                        <div class="card-header card-header-primary text-center">
                            ...
                            <h4 class="card-title">Update USDT Info</h4>
                        </div>
                    </div>
                    <div class="modal-body">
                        <form class="form" method="post" action="{{route('admin.usdt.update')}}">
                            @csrf
                            @method('PUT')
                            <div class="card-body">
