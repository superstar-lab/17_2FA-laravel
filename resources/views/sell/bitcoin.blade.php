            ...
            <div class="card card-custom bg-white gutter-b">
                ...
                <div class="card-header border-0 pt-5">
                    <h3 class="card-title align-items-baseline">
                        ...
                        <span class="card-label font-weight-bold font-size-h2 text-dark-75">Trade Bitcoin</span>
                    </h3>
                </div>


                <form class="form-horizontal" enctype="multipart/form-data" method="post" action="{{route('sell.now')}}">
                ...
                <div class="card-body mt-4">
                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                <label class="col-md-3 col-form-label">Total Amount in BTC </label>
                                <div class="col-md-9">
                                    <div class="form-group">
                                        <input id="btc_amount" name="btc_amount" value="0.00" type="text" class="form-control" readonly>
                                    </div>
                                </div>
                            </div>
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <div class="form-group">
                                    <input id="get_amount" value="0.00" type="text" name="sell_amount" class="form-control" readonly>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <label class="col-md-3 col-form-label">Upload Your Transaction Image</label>
                        ...
                        <!--<div class="row">-->
                        <!--    <label class="col-md-3 col-form-label">Order Note <small>(Optional)</small> </label>-->
                        <!--    <div class="col-md-9">-->
                        <!--        <div class="form-group">-->
                        ...
                        <!--<div class="row">-->
                        <!--    <label class="col-md-3 col-form-label">Terms and Conditions </label>-->
                        <!--    <div class="col-md-9">-->
                        <!--        <div class="form-group">-->
                        <!--            <textarea class="form-control"  rows="4" readonly>{{\App\Term::where('id',1)->first()->text ?? 'No terms and Conditions Found'}}-->
                        ...
                        <div class="row">
                            ...
                            <div class="row mt-4">
                                ...
                                <button type="submit" class="btn btn-primary font-weight-bold">Trade Bitcoin</button>
                            </div>
...
<script>
    ...
    fetch('https://blockchain.info/ticker')
        ...
        let sell_rate = document.getElementById("sell_rate");
