            ...
            <div class="card card-custom bg-white gutter-b">
                ...
                <div class="card-header border-0 pt-5">
                    <h3 class="card-title align-items-baseline">
                        ...
                        <span class="card-label font-weight-bold font-size-h2 text-dark-75">Trade USDT</span>
                    </h3>
                </div>
                ...
                <div class="card-body mt-4">
                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                <label class="col-md-3 col-form-label">Total Amount in USDT </label>
                                <div class="col-md-9">
                                    <div class="form-group">
                                        <input id="btc_amount" name="usdt_amount" value="0.00" type="text" class="form-control" readonly>
                                    </div>
                                </div>
                            </div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="row mt-4">
                                ...
                                <button type="submit" class="btn btn-primary font-weight-bold">Trade USDT</button>
                            </div>
