...
@section('content')
    <div class="col-md-12">
        <div class="card ">
            <form class="form-horizontal" enctype="multipart/form-data" method="post" action="{{route('blogs.store')}}">
                ...
                <div class="card-body mt-4">
                        ...
                        <div class="col-md-9">
                            <select id="cardSelection" class="selectpicker" name="online" data-style="select-with-transition" title="Choose Card" data-size="7" required="true">
                                <option disabled> Select Online status?</option>
                                    ...
                                    <option value="1" {{old('online') == '1' ? 'selected' : ''}}>YES </option>
                            </select>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <div class="form-group">
                                <input value="{{old('title') }}" type="text" name="title" class="form-control" required="true">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                            ...
                            <div class="col-md-9">
                                <div class="form-group">
                                    <textarea name="meta_description" class="form-control" rows="5" required="true">{{old('meta_description') }}</textarea>
                                </div>
                            </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <div class="form-group">
                                    <textarea id="summary" class="form-control" name="summary" rows="4">{{old('summary')}}</textarea>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card-footer ">
                    <div class="row">
                        <div class="col-md-9">
                            <input type="submit" name="submit" class="btn btn-fill btn-rose" value="Create Blog" />
                        </div>
                    </div>
                </div>
            </form>
